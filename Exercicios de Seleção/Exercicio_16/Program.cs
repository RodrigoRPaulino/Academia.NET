...
Console.WriteLine("Escreva um algoritmo que leia o placar de um jogo da primeira fase da copa do Brasil. Caso o time de fora tenha ganho\n" +
    " o jogo por mais de 2 gols de diferença, mostrena tela uma mensagem indicando que o time de fora já se classificou para a próxima fase.\n" +
    "Caso contrário, mostre uma mensagem indicando que os dois times irão se enfrentar novamente em um novo jogo.\n" +
    "ex: time da casa 4 x 3 time de fora, mostra Os dois times se enfrentarão em um novo jogo ex2:\n" +
